...
let procedence = 'Category Food Component NETWORK';
function upsert(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('This IS The File:', req.files);
        const datas = {
            type: 'category_food_component_register',
            datas: req.body,
            files: req.files
        };
...
function update(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = {
            ...
            datas: req.body,
            type: 'category_food_component_update'
        };
        yield index_1.default
            .update(data)
            .then((datasAlter) => {
...
function patch(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = {
            id: req.params.id,
            type: 'category_food_component_patch_active'
        };
        yield index_1.default
            .patch(data)
            .then((datasAlter) => {
...
function remove(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = {
            id: req.params.id,
            type: 'category_food_component_delete'
        };
        yield index_1.default
            .remove(data)
            .then((datasAlter) => {
