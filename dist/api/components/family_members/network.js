...
router.post('/create', (0, secure_1.default)('create'), upload.single('file'), upsert);
router.post('/create/list', (0, secure_1.default)('create'), upload.single('file'), upsertList);
router.get('/:id', get);
...
function upsertList(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('This IS The File:', req.files);
        const datas = {
            type: 'family_member_register',
