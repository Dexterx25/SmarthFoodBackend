                ...
                try {
                    ...
                    if (!foods) {
                        if (query === null || query === void 0 ? void 0 : query.length) {
                            const categoration = query == 'dinner' ? model_2.CateoryFoodEnum[query] : query == 'lunch' ? model_2.CateoryFoodEnum[query] : query == 'breakfast' && model_2.CateoryFoodEnum[query];
                            foods = yield store.query(table, { category_id: categoration }, new Array('category_foods'));
                        }
                        else {
